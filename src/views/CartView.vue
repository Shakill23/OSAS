<template>
    <div class="mt-5 pt-5" v-if="$cookies.get('jwt')">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
            ...
            <div class="offcanvas-body" v-for="i in getfavs()" v-bind:key="i.productID" id="scroll">
                <p>{{ i.productName }}</p>
                <img :src="i.prodUrl" height="50" width="50" loading="lazy" class="img img-fluid shadow mx-2 border p-1 my-4"/>
            </div>
        </div>

        <div v-for="cart in searchByName() || sortBy()" v-bind:key="cart.productID" class="mt-3" id="cart">
            ...
            <div id="borderLR" class="mx-3 container">
                ...
                <div class="py-2 my-3 px-4 d-flex gap-2 border-top">
                    <button @click="addToFavs(cart)" class="btn bg-white shadow border text-white" :title="'add ' + cart.productName + ' to favourites'"><i class="fa-regular fa-heart fa-lg fa-beat" style="color: #ff0000;"></i></button>
    ...
    methods : {
        ...
        searchByName(){
            ...
            let resultY = storageArr.filter(cart => {
                return cart.productName.toLowerCase().includes(inputX.toLowerCase())
            });
            return resultY;
        },
        sortBy(){
